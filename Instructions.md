...
- Your login: is mfwsuser12@demo.broadcom.com
...
- Your userid is CUST012.
- Your password CUST012.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS12 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS12 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST012.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST012.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST012
Password: Mfuser12@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-12.git`
